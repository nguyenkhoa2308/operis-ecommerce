  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-white shadow-lg border border-border flex items-center justify-center hover:scale-105 transition-all duration-300 ${
          open
        ...
        <div className="flex-1 overflow-y-auto px-4 py-5 space-y-4">
          ...
          {sending && (
            <div className="flex justify-start">
              <div className="bg-muted text-muted-foreground px-4 py-2.5 rounded-2xl rounded-bl-md text-base flex items-center gap-2">
        ...
        <div className="border-t border-border px-4 py-3">
          ...
          >
            <input
              ...
              className="flex-1 bg-muted rounded-full px-4 py-2.5 text-base outline-none focus:ring-1 focus:ring-primary transition-shadow"
            />
            <button
              type="submit"
